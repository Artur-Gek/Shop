    ...
    <div class="container">
      <div class="block">
        <div class="shop_product_up">
          <img class="shop_product_up" src="@/assets/images/белаяшапка.jpg" />
        </div>
        <div class="info_product">
          ...
          <p>
            <button
              v-on:click="$store.commit('AddToCartH')"
              class="addToCart"
              :disabled="$store.state.quantity == 0"
            >
              ADD TO CART-->
            </button>
          </p>
      ...
      <div class="recomended">
        <h3>RECOMMENDED FOR PURCHASE</h3>
      </div>
...
import comp_Quantity from "@/components/comp_Quantity.vue";
import comp_futer from "@/components/comp_futer.vue";
export default {
  components: {
    comp_Header,
    comp_Quantity,
